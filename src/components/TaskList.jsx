import { Checkbox, Chip, IconButton, Paper, Table, TableBody, TableContainer, TableHead, TableRow } from "@mui/material"
        ...
        <TableBody>
          {tasks.map((task) => (
            <StyledTableRow key={task.id}>
              ...
              <StyledTableCell sx={{textDecoration: task.completed ? 'line-through' : 'none', color: task.completed ? 'grey.500': 'inherit'}}>
                {task.title}
              </StyledTableCell>
              <StyledTableCell >
                <Chip 
